...
if params.TYPE == "sim":
    ...
    enb1 = request.RawPC('enb1', component_id='pc840')
    if params.FIXED_ENB:
    ...
    rue1 = request.RawPC('rue1', component_id='pc717')
    if params.FIXED_UE:
    ...
    rue1.addService(rspec.Execute(shell="sh", command=GLOBALS.OAI_CONF_SCRIPT + " -r UE"))
